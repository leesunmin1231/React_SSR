...
`,k=require("axios");var $=e.n(k);async function C(e,t){return $().post(e,t,{headers:{"Content-Type":"application/json"}})}const A=(0,x.atom)({key:"modal",default:{display:!1,message:"",buttons:[]}});function E(){const e=(0,x.useSetRecoilState)(A);return{setContent:(t,o=[])=>{e({display:!0,message:t,buttons:o})},closeModal:()=>{e({display:!1,message:"",buttons:[]})}}}function T(){const{setContent:e,closeModal:o}=E(),n=(0,u.useQueryClient)(),[r,s]=(0,b.useState)(!1),i=(0,b.useRef)(null),[l,a]=(0,b.useState)({title:"",content:""}),d=(0,u.useMutation)(["postNewTodo"],(e=>async function(e,t){const o=localStorage.getItem("token");if(null===o)throw new Error("token error");return(await $().post("/todos",t,{headers:{"Content-Type":"application/json",Authorization:o}})).data.data}(0,{...e})),{onSuccess:()=>{n.invalidateQueries(["todos"])},onError:t=>{e(`${t.response.status}: ${t.response.statusText}\nmessage: ${t.response.data.message}`,[{name:"확인",handler:o}])}}),c=()=>{d.mutate(l),a({title:"",content:""}),s(!r)};return(0,b.useEffect)((()=>{i.current&&i.current.focus()}),[r]),(0,t.jsx)(S,{displayWriteBox:r,children:r?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(I,{children:[(0,t.jsx)(q,{type:"text",placeholder:"제목",onChange:e=>a((t=>({...t,title:e.target.value}))),onKeyDown:e=>{if(e.nativeEvent.isComposing)return;const{key:t}=e;"Enter"===t&&c()},value:l.title,ref:i}),(0,t.jsx)(w,{onClick:c,children:"✓"})]}),(0,t.jsx)(R,{placeholder:"상세 내용을 입력하세요",onChange:e=>a((t=>({...t,content:e.target.value})))})]}):(0,t.jsxs)(I,{onClick:()=>s(!r),children:[(0,t.jsx)(q,{type:"text",placeholder:"무엇을 해야하나요?",value:l.title,disabled:!0}),(0,t.jsx)(w,{children:"+"})]})})}const S=g().div`
  width: 100%;
...
`,Y=j().memo((function({currentTodo:e}){const o=(0,u.useQueryClient)(),[n,r]=(0,b.useState)({title:e.title,content:e.content}),[s,i]=(0,b.useState)(!1),[l,a]=(0,b.useState)(!1),[d,c]=(0,b.useState)(!1),{setContent:h,closeModal:p}=E(),x=(0,u.useMutation)("updateTodo",(t=>async function(e,t){const o=localStorage.getItem("token");if(null===o)throw new Error("token error");return(await $().put(e,t,{headers:{"Content-Type":"application/json",Authorization:o}})).data.data}(`/todos/${e.id}`,t)),{onSuccess:()=>{o.invalidateQueries(["todos"])},onError:e=>{h(`${e.response.status}: ${e.response.statusText}\nmessage: ${e.response.data.message}`,[{name:"확인",handler:p}])}}),m=(0,u.useMutation)("deleteTodo",(()=>async function(e){const t=localStorage.getItem("token");if(null===t)throw new Error("token error");return(await $().delete(e,{headers:{"Content-Type":"application/json",Authorization:t}})).data.data}(`/todos/${e.id}`)),{onSuccess:()=>{o.invalidateQueries(["todos"])},onError:e=>{h(`${e.response.status}: ${e.response.statusText}\nmessage: ${e.response.data.message}`,[{name:"확인",handler:p}])}}),g=()=>{i(!1),a(!1),x.mutate(n)},f=()=>{m.mutate(),p()};return(0,b.useEffect)((()=>{let e;return l?c(!0):e=setTimeout((()=>c(!1)),200),()=>{clearTimeout(e)}}),[l]),(0,t.jsxs)(G,{displayWriteBox:l,children:[s?(0,t.jsxs)(D,{children:[(0,t.jsx)(z,{type:"text",placeholder:"",onChange:e=>r((t=>({...t,title:e.target.value}))),onKeyDown:e=>{if(e.nativeEvent.isComposing)return;const{key:t}=e;"Enter"===t&&g()},value:n.title,autoFocus:!0}),(0,t.jsx)(w,{onClick:g,children:"✓"})]}):(0,t.jsxs)(D,{children:[(0,t.jsx)(F,{onClick:()=>a(!l),children:(0,t.jsx)(L,{children:e.title})}),(0,t.jsxs)(B,{children:[(0,t.jsx)(v,{onClick:()=>(i(!0),void a(!0)),isDelete:!1,children:"수정"}),(0,t.jsx)(v,{onClick:()=>{h("삭제 하시겠습니까?",[{name:"취소",handler:p},{name:"삭제",handler:f}])},isDelete:!0,children:"삭제"})]})]}),(0,t.jsx)(M,{displayWriteBox:l,children:d&&(0,t.jsx)(R,{placeholder:"",onChange:e=>r((t=>({...t,content:e.target.value}))),value:n.content,disabled:!s})})]})})),G=g().div`
  width: 100%;
...
`,L=g().div`
  ...
  font-size: 25px;
`,W=require("react-loading");var H=e.n(W);function P(){return(0,t.jsx)(K,{children:(0,t.jsx)(H(),{type:"spin",color:"#5A85E3"})})}const K=g().div`
  width: 20px;
  height: 20px;
  display: flex;
  justify-content: center;
...
`,U=g().div`
  ...
  align-items: center;
  flex-direction: column;
`;function V(){const e=(0,h.useNavigate)(),{isLogined:o}=function(){const[e,t]=(0,b.useState)(!1),{setContent:o,closeModal:n}=E(),r=(0,h.useNavigate)();return(0,b.useEffect)((()=>{null===localStorage.getItem("token")&&(r("/auth/login"),o("로그인이 필요한 페이지 입니다.",[{name:"확인",handler:n}])),t(!0)}),[]),{isLogined:e}}();return(0,t.jsxs)(U,{children:[(0,t.jsxs)(Z,{children:[(0,t.jsx)(X,{children:"LOGO"}),o?(0,t.jsx)(y,{onClick:()=>{localStorage.removeItem("token"),e("/auth/login")},children:"Logout"}):(0,t.jsx)(h.Link,{to:"/auth/login",children:(0,t.jsx)(y,{children:"Login"})})]}),(0,t.jsx)(b.Suspense,{fallback:(0,t.jsx)(P,{}),children:(0,t.jsx)(O,{})})]})}const X=g().div`
  color: ${({theme:e})=>e.colors.WHITE};
  font-size: 30px;
  font-weight: 500;
`,Z=g().nav`
