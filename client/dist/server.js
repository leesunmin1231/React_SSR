...
`,W=require("react-loading");var H=e.n(W);function P(){return(0,t.jsx)(K,{children:(0,t.jsx)(H(),{type:"spin",color:"#5A85E3"})})}const K=g().div`
  ...
  align-items: center;
  margin-top: 20px;
`,O=j().memo((function(){const{setContent:e,closeModal:o}=E(),{data:n,isLoading:r}=(0,u.useQuery)(["todos"],(()=>async function(e){const t=localStorage.getItem("token");if(null===t)throw new Error("token error");return(await k().get("/todos",{headers:{"Content-Type":"application/json",Authorization:t}})).data.data}()),{refetchOnWindowFocus:!0,staleTime:6e4,suspense:!0,onError:t=>e(`${t}`,[{name:"확인",handler:o}])});return(0,t.jsxs)(N,{children:[(0,t.jsx)(Q,{children:"Todo List"}),r?(0,t.jsx)(P,{}):(0,t.jsxs)(_,{children:[(0,t.jsx)(T,{}),n&&n.map((e=>(0,t.jsx)(Y,{currentTodo:e},e.id)))]})]})})),_=g().div`
  width: 100%;
  height: min-content;
  background-color: ${({theme:e})=>e.colors.WHITE};
